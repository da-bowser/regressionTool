...
public class IntegratedConfiguration extends IntegratedConfigurationMain {
	...
	public static byte[] createGetMessagesWithSuccessors(IntegratedConfiguration ico) {
		...
		try {
	        ...
	        Map<String, String> messageIdMap = Util.getRelevantMessageIds(IntegratedConfigurationMain.MAP_FILE_MESSAGE_IDS, GlobalParameters.FILE_DELIMITER, ico.getName(), 1, 2);
