...
public class WebServiceUtil {
	...
	public static String lookupMessageKey(String messageId, String icoName) throws HttpException, ExtractorException {
		...
		byte[] getMessageByIdsRequestBytes = XmlUtil.createGetMessagesByIDsRequest(messageId);
	...
	static byte[] lookupSuccessors(String messageId, String icoName) throws HttpException {
